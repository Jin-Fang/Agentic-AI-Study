...
| [第 1 章](./01-what-is-an-agent-harness.md) | 什么是 Agent Harness？ | Model + Harness 公式、agent 循环、内外层 harness 与历史脉络 |
...
| [第 4 章](./04-tools-agent-computer-interface.md) | 工具与 Agent-Computer Interface | 工具设计、MCP、命名空间、节省 token 的响应、代码执行作为元工具 |
| [第 5 章](./05-sandboxing-guardrails.md) | 沙箱、护栏与安全自治 | 安全威胁模型、权限疲劳、文件系统/网络隔离、hooks、前馈与反馈 |
