...
These are the two ends of one dial. Turning it toward fewer prompts risks blind trust; toward more prompts risks fatigue. The resolution is not a global setting but *stake-proportionate* interaction: calibrate how much the human is asked to the reversibility and blast radius of the action (§15.3).
