...
Full bibliography for *Agent Harness: A Practitioner's Textbook*.
...
(See also *ReAct* under Foundations, the base reasoning-and-acting pattern.)
...
- Mert Cemri et al., *Why Do Multi-Agent LLM Systems Fail?* (introducing the MAST failure taxonomy), UC Berkeley / arXiv, Mar 2025.
...
- Joel Becker, *Clarifying Limitations of Time Horizon*, METR, Jan 22, 2026.
...
## Agent Fleets, Identity, and Control Plane
...
## Protocols, Standards, and Provider Contracts

The mutable provider documentation in this section was verified on **2026-07-31**. Product behavior, availability, pricing, retention, and accounting remain provider- and date-specific.
...
## Additional Primary Sources Used Inline

Mutable documentation in this section was verified on **2026-07-31**.
...
- IETF, *RFC 9110: HTTP Semantics*, Jun 2022.
...
- IETF, *RFC 8693: OAuth 2.0 Token Exchange*, Jan 2020.
...
- *Learn Harness Engineering — English Edition*, Walking Labs.
  https://walkinglabs.github.io/learn-harness-engineering/en/

- *Learn Harness Engineering — Chinese Edition*, Walking Labs.
  https://walkinglabs.github.io/learn-harness-engineering/zh/

- *Learn Harness Engineering — Skills (English)*, Walking Labs.
  https://walkinglabs.github.io/learn-harness-engineering/en/skills/

- *Learn Harness Engineering — Skills (Chinese)*, Walking Labs.
