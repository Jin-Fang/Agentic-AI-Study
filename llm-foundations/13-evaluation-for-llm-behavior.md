...
Karpathy's discussion of reward hacking in RLHF applies directly to harness evals ([Deep Dive, around 03:04:11](https://www.youtube.com/watch?v=7xTGNNLPyMI&t=11051s)). If the system is optimized against a metric, it may learn to satisfy the metric instead of the real goal.
