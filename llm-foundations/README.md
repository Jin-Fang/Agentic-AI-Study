...
Chinese version will use the parallel directory `../llm-foundations-zh/`.
...
The chapters also cite foundational papers where they anchor specific concepts.
...
| [Chapter 2](./02-tokenization.md) | Tokenization | Text-to-token conversion, subwords, budgets, and surprising edge cases |
| [Chapter 3](./03-next-token-prediction.md) | Next-Token Prediction | The pretraining objective and why it produces broad capability |
...
| [Chapter 5](./05-training-data-and-scaling.md) | Data and Scaling | Web data, filtering, model size, dataset size, and compute tradeoffs |
| [Chapter 6](./06-inference-and-sampling.md) | Inference and Sampling | Logits, temperature, top-p, determinism, and operational stability |
| [Chapter 7](./07-post-training.md) | Post-Training | SFT, RLHF, preference optimization, and assistant behavior |
| [Chapter 8](./08-prompting-and-in-context-learning.md) | Prompting and In-Context Learning | Instructions, few-shot examples, chain-of-thought, and prompt boundaries |
| [Chapter 9](./09-context-window-and-kv-cache.md) | Context Windows and KV Cache | Finite context, attention cost, cache reuse, and memory illusions |
| [Chapter 10](./10-knowledge-hallucination-uncertainty.md) | Knowledge, Hallucination, and Uncertainty | Parametric knowledge, factuality, calibration, and verification |
...
| [Chapter 12](./12-reasoning-tools-and-agents.md) | Reasoning, Tools, and Agents | Tool use as an externalized computation pattern |
| [Chapter 13](./13-evaluation-for-llm-behavior.md) | Evaluating LLM Behavior | Test sets, traces, regressions, and harness-level evaluation |
...
If you are already building agents, the most immediately useful chapters are 6, 9, 10, 11, 12, and 13.
